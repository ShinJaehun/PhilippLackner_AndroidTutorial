package com.shinjaehun.runningapp.services
...
import com.shinjaehun.runningapp.other.Constants.FASTEST_LOCATION_INTERVAL
import com.shinjaehun.runningapp.other.Constants.LOCATION_UPDATE_INTERVAL
import com.shinjaehun.runningapp.other.Constants.NOTIFICATION_CHANNEL_ID
import com.shinjaehun.runningapp.other.Constants.NOTIFICATION_CHANNEL_NAME
import com.shinjaehun.runningapp.other.Constants.NOTIFICATION_ID
import com.shinjaehun.runningapp.other.Constants.TIMER_UPDATE_INTERVAL
import com.shinjaehun.runningapp.other.TrackingUtility
import com.shinjaehun.runningapp.ui.MainActivity
...
//        이해하기 어려움! 굳이 MutableList<MutableList<LatLng>>? 그냥 MutableList<LatLng>은 안돼?
...
//                        startForegroundService()
    ...
    private fun updateNotificationTrackingStage(isTracking: Boolean) {
        ...
        if (!serviceKilled) { // serviceKilled 안 된 상태에서만!
            curNotificationBuilder = baseNotificationBuilder
    ...
    private fun addPathPoint(location: Location?) {
        location?.let {
            ...
            pathPoints.value?.apply {
                last().add(pos) // 그니까 이게 [[]]에서 last()인 [], 여기에 add()한다는 거지?
...
//        addEmptyPolyline() // moved to startTimer()
        startTimer()
        isTracking.postValue(true)
